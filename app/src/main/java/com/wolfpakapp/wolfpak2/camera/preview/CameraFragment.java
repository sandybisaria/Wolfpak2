...
import com.wolfpakapp.wolfpak2.camera.editor.PictureEditorFragment;
...
public class CameraFragment extends Fragment
    ...
    private void startPictureEditorFragment()   {
        ...
        transaction.replace(R.id.main_activity_view_pager, PictureEditorFragment.newInstance()); // TODO replace r.id with main activity... or whatever
